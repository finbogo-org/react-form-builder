    ...
    return (
      <div className="dynamic-option-list">
        <ul>
          <li>
            <div className="row">
              <div className="col-sm-6"><b><IntlMessages id="options"/></b>
              </div>
              {this.props.canHaveOptionValue &&
                <div className="col-sm-2"><b><IntlMessages id="value"/></b>
                </div>}
              {this.props.canHaveOptionValue && this.props.canHaveOptionCorrect &&
                <div className="col-sm-4 items-center"><b><IntlMessages
                  id="correct"/></b>
                </div>}
            </div>
          </li>
          <ul className="space-y-2"> {/* This will add space between each li */}
              ...
              return (
                <li className="clearfix" key={this_key}>
                  <div className="row">
                    ...
                    {this.props.canHaveOptionValue && this.props.canHaveOptionCorrect && (
                      <div className="col-sm-1 justify-center items-center">
                        <input
                          className="h-5 w-5 mt-2 form-control"
                          type="checkbox"
                          value="1"
                    ...
                    <div className="col-sm-3">
                      <div
                        className="dynamic-options-actions-buttons inline-flex gap-x-2">
                        <button onClick={this.addOption.bind(this, index)}
                                className="btn text-white bg-[#b1db00]"><i
